...
-file ../../bigDataProgramming/part2/mapper.py -mapper ../bigDataProgramming/part2/mapper.py \
-file ../../bigDataProgramming/part2/reducer.py -reducer ../bigDataProgramming/part2/reducer.py \
