...
/usr/local/hadoop/bin/hdfs dfs -copyFromLocal ../../data/train.csv /proj2/part1/input/
/usr/local/hadoop/bin/hdfs dfs -copyFromLocal ../../data/test.csv /proj2/part1/input/
